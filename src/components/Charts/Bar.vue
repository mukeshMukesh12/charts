<template>
  <svg
    ...
    class="bar-chart"
  >
    <g :transform="stageTransform" class="stageTransform">
      <text
        :x="namePosition.x"
        :y="namePosition.y"
        text-anchor="middle"
      >{{ name }}</text>
      <g ref="bandSeries" class="bandSeries"/>
      <g
        ref="bandsAxis"
        :transform="bandsAxisTransform"
        class="bandsAxis"
      />
      <g ref="valueAxis" class="valueAxis"/>
      <g
        ref="legend"
      ...
      >
        ...
        <text
          ...
          class="value-item"
        >
          <tspan class="name-tooltipdataindex">{{ names[tooltip.data.index] }}: </tspan>
        ...
        methods: {
            ...
            drawBands() {
                ...
                const $band = $bandSeries.selectAll('g').data(this.data)
                    ...
                    .append('rect')
                    .attr('class', 'bar')
                    .attr('x', d => {console.log(d.column,"column");return this.scale.bandItem(d.column)})
